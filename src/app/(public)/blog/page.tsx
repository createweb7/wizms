      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-12" style={{ backgroundColor: '#295e8f' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-blue-100 text-lg">
            Insights and expertise on ISO certification and management systems
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              ...
              <>
                    ...
                    >
                      <div className="p-6">
                        <div className="flex items-center gap-4 mb-4">
                          {blog.category && (
                            <span className="inline-block px-3 py-1 rounded-full text-sm font-semibold text-white" style={{ backgroundColor: '#295e8f' }}>
                              {blog.category}
                            </span>
                          )}
                          {blog.publish_date && (
                        ...
                        <Link href={`/${blog.slug}`}>
                          <h2 className="text-2xl font-bold text-gray-900 mb-2 transition-colors hover:opacity-70" style={{ color: '#295e8f' }}>
                            {blog.title}
                          </h2>
                        </Link>
                ...
                <div className="mt-12 flex items-center justify-between">
                  <button
                    ...
                    style={{ backgroundColor: currentPage === 1 ? '#ccc' : '#ee991a' }}
                  >
                    ← Previous
                  </button>
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-white rounded disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
                    style={{ backgroundColor: currentPage === totalPages ? '#ccc' : '#ee991a' }}
                  >
                    Next →
                  </button>
                </div>
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Search Here</h2>
              <div className="flex gap-2">
                ...
                />
                <button className="px-4 py-3 text-white rounded-lg hover:opacity-90 transition-colors" style={{ backgroundColor: '#ee991a' }}>
                  🔍
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <div className="space-y-6">
                {recentBlogs.map((blog) => (
                  <div key={blog.slug} className="pb-6 border-b border-gray-200 last:border-b-0">
                    <div>
                      ...
                      <Link href={`/${blog.slug}`}>
                        <h3 className="text-sm font-bold text-gray-900 transition-colors line-clamp-2 hover:opacity-70" style={{ color: '#295e8f' }}>
                          {blog.title}
                        </h3>
                      </Link>
                    </div>
            ...
            {/* CTA Section */}
            <div className="rounded-lg p-6 text-center text-white" style={{ backgroundColor: '#ee991a' }}>
              <h3 className="text-2xl font-bold mb-3">Have Any Questions? Call Us Today!</h3>
